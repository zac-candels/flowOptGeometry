...
if (__name__ == "__main__"):
    units = UnitConverter(dx=0.01, dt=0.01, surface_tension=[0.0728,0.1])
    ...
    print("5cm in lattice units:", units.toLattice(0.05, m=1))
    ...
    print("g in lattice units:", units.toLattice(9.81, m=1, s=-2))