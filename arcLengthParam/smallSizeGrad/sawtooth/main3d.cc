...
// Initialisation for MPI parallelisationm you can ignore this
    ...
    saver.loadParameter<OrderParameter<>>(datadir+"/OrderParameter_t924000.mat");
    saver.loadParameter<Pressure<>>(datadir+"/Pressure_t924000.mat");
    saver.loadParameter<Velocity<>,Lattice::NDIM>(datadir+"/Velocity_t924000.mat");
    ...
    for (int timestep = 924000; timestep <= timesteps; timestep++) {
