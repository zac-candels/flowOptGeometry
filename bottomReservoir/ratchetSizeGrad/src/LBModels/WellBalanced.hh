...
class GradPressureForce : public ForceBase<TMethod> {
   public:
    template <class TTraits>
    inline double computeXYZ(const int xyz, const int k) {
        return -(Gradient<Pressure<>>::get<typename TTraits::Lattice, TTraits::Lattice::NDIM>(k,xyz));//+(GradientBiased<Pressure<>>::get<typename TTraits::Lattice, TTraits::Lattice::NDIM>(k,xyz));
    }
    template <class TTraits>
    inline double computeQ(const int idx, const int k) {
        return -(Gradient<Pressure<>>::get<typename TTraits::Lattice, TTraits::Stencil::Q>(k,idx));//+(GradientBiased<Pressure<>>::get<typename TTraits::Lattice, TTraits::Stencil::Q>(k,idx));
    }
    template <class TTraits>
    inline double computeVelocitySource(const int xyz, const int k) {  // Need to correct velocity
...
using DefaultTraitPressureWellBalanced = typename DefaultTrait<TLattice,2> :: template SetBoundary<BounceBack>
                                                               ...
                                                               :: template SetForce< PressureForceWellBalanced<WellBalancedForce<NoTauDependence>,ChemicalForceBinaryMu>, PressureForceWellBalancedTau<SimpleForcingQ<SplitGuoPrefactor>,ChemicalForceBinaryMu> >;

template<class TLattice>
using DefaultTraitPressureWellBalanced2 = typename DefaultTrait<TLattice,2> :: template SetBoundary<BounceBack>
                                                               :: template SetProcessor<GradientsMultiStencil<Density<>,CentralXYZBounceBack>,GradientsMultiStencil<Pressure<>,CentralQBounceBack,CentralXYZBounceBack>,GradientsDirectional<Velocity<>, CentralXYZBounceBackDirectional>>
...
using DefaultTraitPressureWellBalancedN2 = typename DefaultTrait<TLattice,Nmax> :: template SetBoundary<BounceBack>
                                                               ...
                                                               :: template SetForce< PressureForceWellBalanced<WellBalancedForce<NoTauDependence>,ChemicalForce>, PressureForceWellBalancedTau<SimpleForcingQ<SplitGuoPrefactor>,ChemicalForce>, GradPressureForce<SimpleForcingQ<GuoPrefactor>> >;//, PressureForceWellBalancedTau<SimpleForcingQ<SplitGuoPrefactor>,ChemicalForce>
